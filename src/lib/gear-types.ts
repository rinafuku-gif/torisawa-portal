...
export const defaultGearItems: GearItem[] = [
  ...
  { id: "g28", category: "キャンプギア", name: "ホットサンドメーカー", product: "CHUMS ホットサンドウィッチクッカー 直火式", price: 4500, quantity: 1, status: "未発注", priority: "推奨", note: "", shopUrl: "https://www.amazon.co.jp/dp/B077GXJCPF" },
  ...
  // E. 備品
  { id: "g49", category: "備品", name: "アメニティボトル", product: "ディスペンサー3本セット 1000ml", price: 5000, quantity: 1, status: "選定中", priority: "必須", note: "", shopUrl: "https://www.amazon.co.jp/dp/B09J8FFY8G" },
  { id: "g50", category: "備品", name: "キッチンツール一式", product: "調理器具10点セット KC-10", price: 15000, quantity: 1, status: "選定中", priority: "必須", note: "", shopUrl: "https://www.amazon.co.jp/dp/B0FT7RZS7Y" },
  { id: "g51", category: "備品", name: "フライパンセット", product: "ニトリ TORERU 6点", price: 8000, quantity: 1, status: "選定中", priority: "必須", note: "省スペース", shopUrl: "https://www.nitori-net.jp/ec/product/8940821s/" },
  { id: "g52", category: "備品", name: "バスタオル", product: "IKEA VAGSJOEN ダークグレー", price: 700, quantity: 15, status: "選定中", priority: "必須", note: "1.5回転分+予備", shopUrl: "https://www.ikea.com/jp/ja/p/vagsjoen-bath-towel-dark-grey-10353609/" },
  { id: "g53", category: "備品", name: "フェイスタオル", product: "IKEA VAGSJOEN ダークグレー", price: 300, quantity: 15, status: "選定中", priority: "必須", note: "1.5回転分+予備", shopUrl: "https://www.ikea.com/jp/ja/p/vagsjoen-hand-towel-dark-grey-80353620/" },
  { id: "g54", category: "備品", name: "食器(皿・ボウル)", product: "IKEA FARGKLAR 10点セット マットグリーン", price: 350, quantity: 30, status: "選定中", priority: "必須", note: "割れ予備含む", shopUrl: "https://www.ikea.com/jp/ja/p/faergklar-10-piece-service-matt-green-00572438/" },
  { id: "g55", category: "備品", name: "カトラリー・箸", product: "IKEA MOPSIG 16点セット", price: 1000, quantity: 4, status: "選定中", priority: "必須", note: "", shopUrl: "https://www.ikea.com/jp/ja/p/mopsig-16-piece-cutlery-set-80343004/" },
  { id: "g56", category: "備品", name: "ゴミ箱(分別)", product: "IKEA DIMPA 3個セット", price: 3000, quantity: 1, status: "選定中", priority: "必須", note: "燃える・ビンカン・ペット", shopUrl: "https://www.ikea.com/jp/ja/p/dimpa-waste-sorting-bag-white-dark-grey-light-grey-30503863/" },
  { id: "g57", category: "備品", name: "スリッパ", product: "ニトリ 拭けるスリッパ", price: 600, quantity: 8, status: "選定中", priority: "必須", note: "ビニールレザー", shopUrl: "https://www.nitori-net.jp/ec/product/7822647s/" },
  { id: "g58", category: "備品", name: "充電ケーブル", product: "Anker PowerLine II 3-in-1", price: 2000, quantity: 2, status: "選定中", priority: "推奨", note: "忘れ物対策", shopUrl: "https://www.amazon.co.jp/dp/B071WNQYV6" },
  { id: "g59", category: "備品", name: "ハンガー", product: "ニトリ すべりにくいアーチ型 10本組", price: 300, quantity: 50, status: "選定中", priority: "推奨", note: "冬場アウター対応", shopUrl: "https://www.nitori-net.jp/ec/product/8470628s/" },
  { id: "g63", category: "家電", name: "タブレット", product: "iPad（機種選定中）", price: 0, quantity: 1, status: "選定中", priority: "必須", note: "チェックイン案内・ゲストガイド表示用" },
  { id: "g64", category: "備品", name: "スマートロック", product: "RemoteLOCK（Airbnb連携対応）", price: 0, quantity: 1, status: "選定中", priority: "必須", note: "唯一Airbnbサイト連携可。3/25までに発注決定が必要" },
  { id: "g65", category: "備品", name: "自転車", product: "選定中", price: 0, quantity: 2, status: "選定中", priority: "推奨", note: "ゲスト貸出用。周辺散策・駅までの移動に" },
  // F. 防災設備
