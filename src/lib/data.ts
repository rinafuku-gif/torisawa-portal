...
export const schedulePhases: SchedulePhase[] = [
  {
    ...
    theme: "ギア確定＆発注",
    tasks: [
      { task: "ギア最終リスト確定", assignee: "Ryo", status: "完了" },
      { task: "オーナーへ発注依頼送信", assignee: "Ryo", status: "完了" },
      { task: "中古品リサーチ（チェア・テーブル等）", assignee: "Ryo", status: "進行中", note: "メルカリ・ヤフオク活用" },
      { task: "照明工事の業者手配", assignee: "Ryo", status: "進行中", note: "電気工事士資格必要" },
  ...
  },
  {
    ...
    theme: "DIY＆搬入",
    tasks: [
      { task: "ギア到着確認", assignee: "Ryo/高木", status: "未着手" },
      { task: "DIY資材購入（有孔ボード・塗料・木材）", assignee: "Ryo", status: "未着手" },
      { task: "有孔ボード設置・Gear Shed作成", assignee: "Ryo", status: "未着手" },
      { task: "照明交換工事", assignee: "業者", status: "未着手" },
      { task: "塗装作業", assignee: "Ryo", status: "未着手" },
  ...
  },
  {
    ...
    theme: "セットアップ",
    tasks: [
      { task: "ギアディスプレイ配置", assignee: "Ryo", status: "未着手" },
      { task: "キッチン・備品設置", assignee: "Ryo", status: "未着手" },
      { task: "スマートロック設置・テスト", assignee: "Ryo", status: "未着手" },
      { task: "Wi-Fi開通・速度確認", assignee: "高木/Ryo", status: "未着手" },
      { task: "タブレット設定", assignee: "Ryo", status: "未着手" },
  ...
  },
  {
    ...
    theme: "許認可＆ルール",
    tasks: [
      { task: "保健所へ営業許可申請", assignee: "Ryo", status: "未着手" },
      { task: "ハウスルール作成（日/英）", assignee: "Ryo", status: "未着手" },
      { task: "ギアレンタル規約作成", assignee: "Ryo", status: "未着手" },
      { task: "周辺情報ガイド作成", assignee: "Ryo", status: "未着手" },
      { task: "OTA掲載文作成", assignee: "Ryo", status: "未着手" },
    ],
  },
  {
    period: "4/2週 (4/6〜12)",
    ...
    tasks: [
      ...
      { task: "写真撮影（リスティング用）", assignee: "Ryo", status: "未着手" },
      { task: "清掃オペレーション確立", assignee: "Ryo", status: "未着手" },
    ],
  },
  {
    period: "4/3-4週 (4/13〜)",
    ...
    tasks: [
      ...
      { task: "Airbnb登録・公開", assignee: "Ryo", status: "未着手" },
      { task: "テスト宿泊（関係者）", assignee: "Ryo+知人", status: "未着手" },
      { task: "モニター価格で受付開始", assignee: "Ryo", status: "未着手", note: "通常の20%OFF等" },
    ],
  },
  {
    period: "5月〜",
    theme: "グランドオープン",
    tasks: [
      { task: "正規料金設定", assignee: "Ryo", status: "未着手", note: "平日12,500/休前日15,500" },
      { task: "Gear Shed外部貸出開始", assignee: "Ryo", status: "未着手" },
      { task: "えんがわ連携告知", assignee: "Ryo", status: "未着手" },
      { task: "月次稼働率モニタリング", assignee: "Ryo", status: "未着手", note: "目標: 5月50%（GW効果）" },
    ],
  },
];
